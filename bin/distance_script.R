...
genotypes <- genotypes[rownames(growth),] # Filter to those strains with growth data
...
save(genetic_distance, growth_distance_NaCl4, growth_distance_NaCl6, file = 'genetic_distance.Rdata')
